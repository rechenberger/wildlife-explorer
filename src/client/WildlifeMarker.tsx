...
export const WildlifeMarker = memo(
  ({ nearMe, isNavigating }: { nearMe: NearMe; isNavigating: boolean }) => {
    WildlifeMarker.displayName = "WildlifeMarker"
    const w = nearMe.wildlife
    const navigatingtoObservationId = useAtomValue(
